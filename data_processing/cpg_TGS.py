...
def graphGeneration(nodes, edges, edge_type_map, ver_edge_type_map):
    ...
    for e in all_edges_new:
        ...
        edges_num[key] += 1
    edges_num['edges_reduced'] = edge_count_before - edge_count_after
...
def main():
    ...
    parser.add_argument('--output_dir', default='devign_dataset/devign_cpg_c1')
    ...
    print("*"*100)
    train_output_path = open(os.path.join(output_dir, 'devign-train-v1.json'), 'w')
    test_output_path = open(os.path.join(output_dir, 'devign-test-v1.json'), 'w')
    valid_output_path = open(os.path.join(output_dir, 'devign-valid-v1.json'), 'w')
    output_files = [train_output_path, test_output_path, valid_output_path]

    train_num_path = open(os.path.join(output_dir, 'devign-train-num-v1.json'), 'w')
    test_num_path = open(os.path.join(output_dir, 'devign-test-num-v1.json'), 'w')
    valid_num_path = open(os.path.join(output_dir, 'devign-valid-num-v1.json'), 'w')
