...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_type', type=str, help='Type of the model (devign)',
                        choices=['devign'], default='devign')
    ...
    parser.add_argument('--num_steps', type=int, help='Number of steps', default=6)
    ...
    train(model=model, dataset=dataset, epoches=100, dev_every=len(dataset.train_batches),
          ...
          save_path=model_dir + '/DevignModel', max_patience=10, log_every=5)
